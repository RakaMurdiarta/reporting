...
def get_vendors_and_saldo_detail(entitas, coa, start_date, task_id):
    ...
    """
    csv_file_path = f"temp/{task_id}_{constants.get_vendors_and_saldo_detail}.csv"
    ...
    try:
        ...
        cursor.close()
        conn.close()
        progress[task_id]["tasks"][constants.get_vendors_and_saldo_detail] = "completed"
        progress[task_id]["filenames"][
            constants.get_vendors_and_saldo_detail
        ] = csv_file_path
        ...
        progress[task_id]["tasks"][constants.get_vendors_and_saldo_detail] = "failed"
