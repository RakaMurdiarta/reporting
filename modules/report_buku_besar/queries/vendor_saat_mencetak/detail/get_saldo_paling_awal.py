...
def get_saldo_paling_awal(task_id: str, coa_number: str, entitas: str):
    ...
    try:
        ...
        cursor.close()
        conn.close()
        progress[task_id]["tasks"]["get_saldo_paling_awal"] = "completed"
        progress[task_id]["filenames"]['get_saldo_paling_awal'] = csv_file_path
        ...
        progress[task_id]["tasks"]["get_saldo_paling_awal"] = "failed"
